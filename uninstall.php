 ...
 * ever creates. Kept in sync with R2C_AI_Concierge_Options (includes/class-r2c-ai-concierge-options.php)
 ...
 * data★ — only local WordPress state. See R2C_AI_Concierge_Ajax::handle_disconnect /
...
// requiring class-r2c-ai-concierge-options.php, so this file has no dependency on the
// rest of the plugin's code still being loadable at uninstall time.
delete_option( 'r2c_ai_concierge_api_key' );
delete_option( 'r2c_ai_concierge_tenant_id' );
delete_option( 'r2c_ai_concierge_site_origin' );
delete_option( 'r2c_ai_concierge_cached_widget_theme' );
delete_option( 'r2c_ai_concierge_connect_notice_dismissed' );
delete_transient( 'r2c_ai_concierge_pending_poll_token' );
delete_transient( 'r2c_ai_concierge_pending_challenge' );
